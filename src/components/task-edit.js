export const createFormEditTask = () => {
  return (
          ...
          <div class="card__settings">
            ...
            <div class="card__colors-inner">
              ...
              <div class="card__colors-wrap">
                ...
                <label for="color-black-4" class="card__color card__color--black">black
                </label>
                ...
                <label for="color-yellow-4" class="card__color card__color--yellow">yellow
                </label>
                <input type="radio" id="color-blue-4" class="card__color-input card__color-input--blue visually-hidden" name="color" value="blue" />
                <label for="color-blue-4" class="card__color card__color--blue">blue
                </label>
